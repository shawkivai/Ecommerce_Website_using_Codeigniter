...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 08, 2017 at 09:17 PM
...
(8, 'parvez ahmed', 'parvez@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', 0);
...
--
ALTER TABLE `tbl_admin`
  MODIFY `admin_id` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;
--
-- AUTO_INCREMENT for table `tbl_bill_info`
--
ALTER TABLE `tbl_bill_info`
  MODIFY `bill_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
--
...
--
ALTER TABLE `tbl_product`
  MODIFY `product_id` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;
--
