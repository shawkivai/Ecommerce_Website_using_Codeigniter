            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="center">
                        ...
                        <a class="btn btn-danger" href="<?php echo base_url();?>super_admin/delete_manufacturer/<?php echo $v_manufacturer->manufacturer_id?>" title="Delete" onclick="return check_delete();">
