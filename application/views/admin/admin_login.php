		...
		<div class="row-fluid">
			...
			<div class="row-fluid">
				<div class="span12 center login-header">
					<h2>Welcome to my Admin Panel for manage Ecommerce site</h2>
				</div><!--/span-->
			</div><!--/row-->
					...
					<div class="alert alert-info">
						...
						<fieldset>
							<div class="input-prepend" title="Username" data-rel="tooltip">
								<span class="add-on"><i class="icon-user"></i></span><input autofocus class="input-large span10" name="admin_email_address" id="username" type="text"  />
							</div>
