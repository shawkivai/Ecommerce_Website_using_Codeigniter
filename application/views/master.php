                    ...
                    <div class="container">
                        <div class="row clearfix">
                            <div class="col-lg-4 col-md-4 col-sm-5 t_xs_align_c">
                                <p class="f_size_small">Welcome visitor can you	<a href="<?php echo base_url(); ?>admin/check_admin_login" data-popup="#login_popup">Log In</a> or <a href="#">Create an Account</a> </p>
                            </div>
...
<div class="popup_wrap d_none" id="login_popup">
    <section class="popup r_corners shadow">
        ...
        <form action="<?php echo base_url(); ?>index.php/admin/check_admin_login" method="post">
            <ul>
