				...
				?>
								...
								<!--description-->
															<h2 class="color_dark fw_medium m_bottom_10"><?php echo $v_category->category_name;?></h2>
								
								<hr class="m_bottom_10 divider_type_3">
								<table class="description_table m_bottom_10">
									<tr>
										<td>Manufacturer:</td>
										<td><a href="#" class="color_dark"><?php echo $product_info->manufacturer_name ;?>Chanel</a></td>
									</tr>
									<tr>
										<td>Availability:</td>
