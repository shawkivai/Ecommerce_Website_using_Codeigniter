...
<div class="bs_inner_offsets bg_light_color_3 shadow r_corners m_bottom_45">
    <figure class="block_select clearfix relative m_bottom_15">
        ...
        <img src="<?php echo base_url('images/cashnd.jpg'); ?>" height="80" width="140" alt="" class="f_left m_right_20 f_mxs_none m_mxs_bottom_10">
        <figcaption>
    ...
    <figure class="block_select clearfix relative">
        ...
        <img src="<?php echo base_url('images/bkash.png') ?>" height="80" width="140" alt="" class="f_left m_right_20 f_mxs_none m_mxs_bottom_10">
        <figcaption>
    ...
    <a href="<?php echo base_url() ?>customer/thank_you"  role="button" class="button_type_4 bg_scheme_color r_corners tr_all_hover color_light f_left mw_0">Submit</a>
