    ...
    <body>
                    ...
                    <div class="container">
                        <div class="row clearfix">
                            <div class="col-lg-4 col-md-4 col-sm-5 t_xs_align_c">
                                <p class="f_size_small">Welcome to Ekhanei.com you are requested to 
                                  <a href="" data-popup="#login_popup">Log In</a> or <a href="#">Create an Account</a> </p>
                            </div>
                            ...
                            <ul class="d_inline_b horizontal_list clearfix t_align_l site_settings">
                                ...
                                <li class="m_left_5 relative container3d">
                                    ...
                                    <ul class="dropdown_list top_arrow color_light">
                                        ...
                                        <li><a href="#" class="tr_delay_hover color_light"><img class="d_inline_middle" src="images/flag_fr.jpg" alt="">Bangla</a></li>
                                        <li><a href="#" class="tr_delay_hover color_light"><img class="d_inline_middle" src="images/flag_g.jpg" alt="">Hindi</a></li>
            ...
            <footer id="footer">
                ...
                <div class="footer_bottom_part">
                    <div class="container clearfix t_mxs_align_c">
                        <p class="f_left f_mxs_none m_mxs_bottom_10">&copy; 2014 <span class="color_light">Ekhanei</span>. All Rights Reserved.</p>
        ...
        <div class="popup_wrap d_none" id="login_popup">
            <section class="popup r_corners shadow">
                ...
                <!--<form action="<?php echo base_url();?>admin/check_admin_login" method="post">-->
                    <ul>
